...
{
    /// <summary>
    /// DTO class that represents a sell order for selling stocks - that can be used while inserting/updating
    /// </summary>
    public class SellOrderRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Converts the SellOrderRequest object into a SellOrder object
        /// </summary>
